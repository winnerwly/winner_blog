	...
	<div class="main layui-clear">
		<div class="wrap">
			<div class="content" style="margin-right:0">
				<div class="fly-tab">
					<span>
						<?php if(($status == -1)): ?><a href="/Question/Index"  class="tab-this" >全部</a>
			          	<?php else: ?>
			          		<a href="/Question/Index"  >全部</a><?php endif; ?> 
			          	
			          	<?php if(($status == 0)): ?><a href="/Question/Index?status=0" class="tab-this" >未结帖</a>
			          	<?php else: ?>
			          		<a href="/Question/Index?status=0" >未结帖</a><?php endif; ?> 
			          	
			          	<?php if(($status == 1)): ?><a href="/Question/Index?status=1" class="tab-this" >已采纳</a>
			          	<?php else: ?>
			          		 <a href="/Question/Index?status=1" >已采纳</a><?php endif; ?> 
			          	
			          	<?php if(($status == 2)): ?><a href="/Question/Index?status=2" class="tab-this" >精帖</a>
			          	<?php else: ?>
			          		<a href="/Question/Index?status=2" >精帖</a><?php endif; ?> 
